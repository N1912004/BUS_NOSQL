...
<body>
    ...
    <div class="">
        ...
        <a class="btn btn-item btn-block" style="width: 50%;" href="AddCon.php">Thêm Nhân viên soát vé</a>
        <a class="btn btn-item btn-block" style="width: 50%;" href="AddDri.php">Thêm Tài xế</a>
        <a class="btn btn-item btn-block" style="width: 50%;" href="SuAdminAddTrip.php">Nhập chi tiết chuyến xe</a>
        <!-- <a class="btn-item" href="ConFillTripDetails.html">Phụ trách chuyến đi</a> -->
    </div>
    ...
    <div class="parent">
        ...
        <div class="child">
            <h3>Kích hoạt (Triggers)</h3>
            <a class="btn btn-item btn-block" style="width: 55%;" href="quicktripsTriggerDisplay.php">Chuyến đi nhanh</a>

            <a class="btn btn-item btn-block" style="width: 55%;" href="LossMakingTriggerDisplay.php">Xe buýt thua lỗ</a>
        </div>

        <div class="child">
            <h3>Chế độ xem (Views)</h3>
            <a class="btn btn-item btn-block" style="width: 55%;" href="Milage.php">Quãng đường xe buýt</a>
            <a class="btn btn-item btn-block" style="width: 55%;" href="AllBusRevenue.php">Doanh thu tạo ra</a>
        </div>
    </div>
