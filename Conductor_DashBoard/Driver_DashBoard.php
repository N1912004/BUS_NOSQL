...
<body>
    <nav id="mainNavbar" class="navbar navbar-light navbar-expand-md py-1 px-2 fixed-top"
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navLinks">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="Driver_Dashboard.php" class="nav-link">TRANG CHỦ</a>
                </li>
                <li class="nav-item">
...
$query = 'FOR b IN busDetails FILTER b.trip_no IN (FOR t IN tripIncharge FILTER t.Driver_emp_id == @DriID RETURN t.trip_no_incharge) SORT b.TripDate DESC LIMIT 1 RETURN { trip_no: b.trip_no, bus_no: b.bus_no, TripDate: b.TripDate }';
