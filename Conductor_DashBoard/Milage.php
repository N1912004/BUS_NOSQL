...
$tableName = "mileage"; // ArangoDB view name
$columns = ['bus_no', 'MILAGE'];

$aqlQuery = 'FOR m IN mileage RETURN { bus_no: m.bus_no, MILAGE: m.MILAGE }';
...
$dataPoints = array();
$aqlChartQuery = 'FOR m IN mileage RETURN { x: m.bus_no, y: m.MILAGE }';
      ...
      <div class="col-sm">
        ...
        <div class='graph'>
          ...
          try {
            ...
            $link = new \PDO(
              'mysql:host=localhost;dbname=bus_HCM;charset=utf8mb4',
