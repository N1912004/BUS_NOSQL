...
$tableName = "quickTrips"; // ArangoDB collection name
$columns = ['Trip_no', 'fuel', 'arrival_time', 'departure_time', 'km_count'];

$aqlQuery = 'FOR q IN ' . $tableName . ' RETURN { Trip_no: q.Trip_no, fuel: q.fuel, arrival_time: q.arrival_time, departure_time: q.departure_time, km_count: q.km_count }';
