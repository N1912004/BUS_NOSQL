...
$query = "FOR t IN trip_incharge FILTER t.Conductor_emp_id == @conid RETURN t.trip_no_incharge";
...
<body>
    ...
    <div class="maindiv" id="maindiv" style="width: 25%;">
        ...
        <form action="tripconnect.php" method="post">
            ...
            <div class="info">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="TripNumber" placeholder="Trip Number" style="padding: 10px;
                        ...
                        <?php foreach ($trip_nos as $doc): ?>
                        <option value="<?php echo $doc->get('trip_no_incharge'); ?>">
                            <?php echo $doc->get('trip_no_incharge'); ?>
                        </option>
                    <?php endforeach; ?>
                ...
                <div class="form-group">
                    <label for="PhoneNumber">Tổng doanh thu tạo ra:</label>
                    <input class="form-control" type="number" name="totalRevenue" placeholder="Doanh thu tạo ra">
                </div>

                <div class="form-group">
                    <label>Tổng số vé đã bán:</label>
                    <input class="form-control" type="number" name="ticketsSold" placeholder="Tổng số vé đã bán">
                </div>
            ...
            <button type="submit" href="/">Nộp</button>
        </form>
    </div>
