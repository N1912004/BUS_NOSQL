...
const fistForm = document.querySelector(".container--signup .form");
const secondForm = document.querySelector(".container--signin .form");
const container = document.querySelector(".container");
const container1 = document.querySelector(".container_overlay");
