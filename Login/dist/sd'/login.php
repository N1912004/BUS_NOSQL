...
$documentHandler = new ArangoDocumentHandler($connection);
	    ...
	    $query = 'FOR u IN login FILTER u.user_name == @username AND u.password == @password RETURN u';
...
$documentHandler = new ArangoDocumentHandler($connection);
	    ...
	    $query = 'FOR u IN loginDriver FILTER u.user_name == @username AND u.password == @password RETURN u';
	    $statement = new ArangoStatement($connection, [
	        'query' => $query,
	        'bindVars' => [
	            'username' => $username,
